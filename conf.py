...
BLOG_AUTHOR = "Chris Morey"  # (translatable)
#BLOG_TITLE = {"ja": "しいちゃん","en": "Shiichan", "fr": "Shiichan"} # (translatable)
BLOG_TITLE = {"en": "Thesis"} # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://shiichan.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://shiichan.github.io/"
BLOG_EMAIL = "chrismorey@example.com"
BLOG_DESCRIPTION = "Thesis Demo website on Github"  # (translatable)
...
NAVIGATION_LINKS = {
    ...
    #"en": (
        ('/en/index.html', '🏠'),
        # TODO: Check the 'hover' example in the code below
        #(
        #    (
        ...
        ("/en/thesis/abstract/", "Abstract"),
        ("/en/thesis/acknowledgements/", "Acknowledgements"),                    
        (
            (
                ('/en/thesis/c1/', '1'),
                ('/en/thesis/c1.1/', '1.1'),
